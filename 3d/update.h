...
double update_lattice(unsigned char* lat, int* epi, float* arr,std::vector<double> &rates, std::vector<double> &c_rates,std::unordered_map<float, std::vector<int>> &dict,const int mx, const int my, const int mz, const int n, const float beta);